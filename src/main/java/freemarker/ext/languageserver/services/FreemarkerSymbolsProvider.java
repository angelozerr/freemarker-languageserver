...
public class FreemarkerSymbolsProvider {

	public static List<SymbolInformation> findDocumentSymbols(TextDocumentItem document, FMDocument fmDocument) {
	...
	private static void provideFileSymbolsInternal(TextDocumentItem document, FMDocument fmDocument, Node node,
